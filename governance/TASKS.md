...
| M-47 | App & UserManagement Unit Coverage (2026-08-17, Active); 2 new suites (App.test.tsx, UserManagement.test.tsx) — covers last 0%-coverage files; components threshold raised from 30/30 |
