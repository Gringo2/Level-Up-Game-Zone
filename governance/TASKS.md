...
| M-49 | Client Coverage — AuthContext/ShiftContext/Credits/EmployeeRoster gaps (2026-08-17, Verification); +26 tests (329 → 355); AuthContext 61.36% → 100% stmts, ShiftContext 86.11% → 100% stmts, Credits 68.80% → 93.6% stmts/95.65% lines, EmployeeRoster 77.24% → 95.12% stmts; contexts {70,85} → {95,90} lines/funcs, pages {80,85} → {85,90}; Red-proofed (4 suites excluded → all four constraints trip); awaiting commit-time lock per ACP-005 |
