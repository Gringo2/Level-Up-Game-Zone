...
- **Source Location:** [Layout.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/layouts/Layout.tsx#L173-L208).
...
- **Role Permission Matrix:**
  ...
  - **Manager:** Staff items + Keno (`/keno`), Credits (`/credits`), Expenses (`/expenses`), Salary Report (`/salary-report`), Reports (`/reports`)
  - **Admin:** All Manager items + Activity Log (`/audit-logs`), User Management (`/admin/users`), Admin Settings (`/admin`)
- **Source Location:** [Layout.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/layouts/Layout.tsx#L74-L125).
...
- **Source Location:** [Dashboard.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/pages/Dashboard.tsx#L322-L327).
...
- **Source Location:** [Dashboard.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/pages/Dashboard.tsx#L185-L221).
...
- **Source Location:** [AuditLogs.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/pages/AuditLogs.tsx#L127-L135).
...
- **Source Location:** [Admin.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/pages/Admin.tsx#L204-L375).
...
- **Behavior:**
  ...
  - **Keno Log:** Entering sales and payout values dynamically computes net profit ($ = sales - payouts).
- **Source Locations:** [GameSales.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/pages/GameSales.tsx), [Keno.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/pages/Keno.tsx).
...
- **Source Location:** [App.tsx](file:///home/gringo2/gringo2/Level-Up-Game-Zone/packages/client/src/App.tsx#L38) (`<Toaster position="top-center" richColors />`).
